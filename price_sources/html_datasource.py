"""An abstract HTML datasource for fetching prices.
...
class HTMLDatasource(BaseDatasource):
    """Download HTML data from a configurable endpoint.

    The class focuses on fetching HTML responses; it raises on HTTP errors
    and on invalid HTML.
    ...
    def fetch(
        ...
        Raises:
            ...
            ValueError if the response body is not valid HTML.
        """
        ...
        try:
            ...
            raise ValueError("Response did not contain valid HTML") from exc
